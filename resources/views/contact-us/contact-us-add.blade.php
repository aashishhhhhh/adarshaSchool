...
<div class="card card-primary">
    ...
    <input type="text" name="school_contact_no" class="form-control"  placeholder="Enter Number">
    ...
    <div class="form-group">
        <label for="exampleInputEmail1">Principle's Contact Number</label>
        <input type="text" name="principle_contact_no" class="form-control"  placeholder="Enter Number">
    ...
    <input type="text" name="school_co_contact_no" class="form-control"  placeholder="Enter Number">
